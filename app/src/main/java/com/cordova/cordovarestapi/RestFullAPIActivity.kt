...
import com.cordova.cordovarestapi.databinding.ActivityRestFullApiactivityBinding
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class RestFullAPIActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRestFullApiactivityBinding
    private lateinit var tweetAdapter: TweetAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRestFullApiactivityBinding.inflate(layoutInflater)
    ...
    private fun setupRecyclerView() {
        ...
        binding.tweetsRecyclerView.apply {
            ...
            layoutManager = LinearLayoutManager(this@RestFullAPIActivity)
        }
    }
